...
plt.plot(dmmData.VoltIn, dmmData.CurrOut001, label = "vpwr=3")
plt.plot(dmmData.VoltIn, dmmData.CurrOut002, label = "vpwr=4")
plt.plot(dmmData.VoltIn, dmmData.CurrOut003, label = "vpwr=5")
plt.plot(dmmData.VoltIn, dmmData.CurrOut004, label = "vpwr=6")
plt.plot(dmmData.VoltIn, dmmData.CurrOut005, label = "vpwr=7")
plt.plot(dmmData.VoltIn, dmmData.CurrOut006, label = "vpwr=8")
plt.plot(dmmData.VoltIn, dmmData.CurrOut007, label = "vpwr=9")
plt.plot(dmmData.VoltIn, dmmData.CurrOut008, label = "vpwr=10")

...
def bankNum(bank, bypass):
    ...
    if bank == 0:
        ...
        picLoc = "C:\\Users\\UTChattsat\\Documents\\SkywaterData\\idvgsCharacterization\\newBoard\\Bank 0\\idvgscharData"
        fileLoc = '~\\Documents\\SkywaterData\\idvgsCharacterization\\newBoard\\Bank 0\\idvgscharData'
        measDelay = -1
        nplc = 16/60
        limiti = 0.001
        rangei = pow(10, -3)
